...
class AddMenuItemsModal extends Component{
  constructor(props) {
    super(props);
    this.state = {
      menu_id: '',
  ...
  onClickAdd = () => {
    ...
    ApiHelper.post('/api/menu_items/', {
      ...
      toastr.success('Success!', 'Menu Item was successfully added.');
      ...
      toastr.error('Fail!', 'Failed to add Menu Item.');
    });
  };
