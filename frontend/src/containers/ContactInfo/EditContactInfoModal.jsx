...
class EditContactInfoModal extends Component{
  constructor(props) {
    super(props);
    this.state = {
      contactID: this.props.selectedContactInfo.contact_id,
      name: this.props.selectedContactInfo.name,
      title: this.props.selectedContactInfo.title,
      value: this.props.selectedContactInfo.value,
      info: this.props.selectedContactInfo.info,
      contactType: this.props.selectedContactInfo.type,
      location: this.props.selectedContactInfo.location,
      errors: {
        contactID: '',
        title: '',
        name: '',
  ...
  onClickSave = () => {
    ...
    ApiHelper.put(`/api/contact-info/${this.props.selectedContactInfo.id}/`, {
      ...
      toastr.success('Success!', 'Contact Info was successfully updated.');
      ...
      toastr.error('Fail!', 'Failed to update Contact Info.');
    });
  };
...
EditContactInfoModal.propTypes = {
  ...
  selectedContactInfo: PropTypes.object
};
