...
class AddTransIDModal extends Component{
  constructor(props) {
    super(props);
    this.state = {
      transNum: '',
  ...
  onClickAdd = () => {
    ...
    ApiHelper.post('/api/trans-ids/', {
      ...
      toastr.success('Success!', 'Trans ID was successfully added.');
      ...
      toastr.error('Fail!', 'Failed to add Trans ID.');
    });
  };
...
AddTransIDModal.propTypes = {
  show: PropTypes.bool,
  onHide: PropTypes.func,
  onSubmit: PropTypes.func,
};

export default AddTransIDModal
