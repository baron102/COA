...
class AddRoleMenuModal extends Component{
  constructor(props) {
    super(props);
    this.state = {
      role_name: '',
  ...
  onClickAdd = () => {
    ...
    ApiHelper.post('/api/role_menu/', {
      ...
      toastr.success('Success!', 'Role Menu was successfully added.');
      ...
      toastr.error('Fail!', 'Failed to add Role Menu.');
    });
  };
    ...
    return(
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Add Role Menu</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form horizontal>
            <FormGroup>
