...
class AddItemReferencesModal extends Component{
  constructor(props) {
    super(props);
    this.state = {
      item_id: '',
  ...
  onClickAdd = () => {
    ...
    ApiHelper.post('/api/item_references/', {
      ...
      toastr.success('Success!', 'Item Reference was successfully added.');
      ...
      toastr.error('Fail!', 'Failed to add Item Reference.');
    });
  };
    ...
    return(
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Add Item References</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form horizontal>
            <FormGroup>
...
AddItemReferencesModal.propTypes = {
  show: PropTypes.bool,
  onHide: PropTypes.func,
  onSubmit: PropTypes.func,
};

export default AddItemReferencesModal
