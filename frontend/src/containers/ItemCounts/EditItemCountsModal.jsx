...
class EditItemCountsModal extends Component{
  constructor(props) {
    super(props);
    this.state = {
      item_id: this.props.selectedID.item_id,
      count_type: this.props.selectedID.count_type,
      info: this.props.selectedID.info,
      plan_total: this.props.selectedID.plan_total,
      plan_rows: this.props.selectedID.plan_rows,
      plan_year: this.props.selectedID.plan_year,
      errors: {
        item_id: '',
        count_type: '',
        plan_total: '',
  ...
  onClickSave = () => {
    ...
    ApiHelper.put(`/api/item_counts/${this.props.selectedID.id}/`, {
      ...
      toastr.success('Success!', 'Item Count was successfully updated.');
      ...
      toastr.error('Fail!', 'Failed to update Item Count.');
    });
  };
    ...
    return(
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Edit Item Count</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form horizontal>
          <FormGroup>
...
export default EditItemCountsModal
