...
class EditItemTransModal extends Component{
  constructor(props) {
    super(props);
    this.state = {
      trans_id: this.props.selectedID.trans_id,
      item_id: this.props.selectedID.item_id,
      tran_date: this.props.selectedID.tran_date,
      trans_user: this.props.selectedID.trans_user,
      trans_type: this.props.selectedID.trans_type,
      entity: this.props.selectedID.entity,
      reference: this.props.selectedID.reference,
      quantity: this.props.selectedID.quantity,
      warehouse: this.props.selectedID.warehouse,
      location: this.props.selectedID.location,
      bin: this.props.selectedID.bin,
      revenue_fld: this.props.selectedID.revenue_fld,
      cost: this.props.selectedID.cost,
      notes: this.props.selectedID.notes,
      errors: {
        trans_id: '',
        item_id: '',
        tran_date: '',
  ...
  onClickSave = () => {
    ...
    ApiHelper.put(`/api/item_trans/${this.props.selectedID.id}/`, {
      ...
      toastr.success('Success!', 'Trans Item was successfully updated.');
      ...
      toastr.error('Fail!', 'Failed to update Trans Item.');
    });
  };
...
export default EditItemTransModal
